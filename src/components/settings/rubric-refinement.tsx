            ...
            {suggestedChanges.map((change) => (
              <TableRow key={change.id}>
                ...
                <TableCell className="text-center">
                    <Badge variant={change.status === 'Approved' ? 'default' : 'secondary'} className={change.status === 'Approved' ? 'bg-green-600/80' : ''}>
                ...
                <TableCell className="text-right">
                  {change.status === 'Pending' ? (
                    <div className="flex gap-2 justify-end">
                      <Button variant="ghost" size="icon" className="text-green-400 hover:text-green-400 hover:bg-green-900/50">
                        <ThumbsUp className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="icon" className="text-red-400 hover:text-red-400 hover:bg-red-900/50">
